...
### 3.1.3经济可行性
基于springboot的学生综合测评系统，该网站软件开发仅需要一台普通的计算机便可完成实现开发，其成本很低。另外，作为毕业设计作品来讲，开发成本基本上可以忽略不计，且该系统软件的投入使用，可以实现更加快速高效的学生综合测评管理，同时还能实现对人力资源和管理资源的有效节约，该学生综合测评系统在经济上完全可行。
## 3.2 需求分析
